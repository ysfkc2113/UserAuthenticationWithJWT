...
namespace Services.Contracts.ClubLeaderService
{
    ...
    {
        Task<(IEnumerable<EventDto> eventDto, MetaData metaData)>  GetAllEventsForClubManagerAsync(ClubManagerEventParameters clubManagerEventParameters, HttpContext httpContext,bool trackChanges);
